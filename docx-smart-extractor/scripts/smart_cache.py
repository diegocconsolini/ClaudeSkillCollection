# VENDORED COPY of shared/smart_cache.py (workspace canonical). Bundled into this
# plugin so it works when installed standalone (fixes audit #44 N2 ModuleNotFoundError).
# Re-sync after canonical changes: cp ../../shared/smart_cache.py scripts/smart_cache.py
#!/usr/bin/env python3
"""
