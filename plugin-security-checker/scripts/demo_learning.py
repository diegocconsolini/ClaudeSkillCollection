...
def main():
    ...
    # Test file with $eval in test code (string literal - not executed)
    test_code_ts = (
        "// Test file\n"
        "describe('eval tests', () => {\n"
    ...
    # Production code with dangerous function (string literal - not executed)
    prod_code_py = (
        "# Production API endpoint\n"
        "def process_data(user_input):\n"
        "    result = __import__('builtins').eval(user_input)  # CRITICAL: Code injection\n"
        "    return result\n"
    )
    ...
    print("-" * 80)
    print("EXAMPLE 2: Production code with dangerous function (Python)")
    print("-" * 80)
    print()
    print("Code:")
    print(prod_code_py)
