#!/usr/bin/env python3
"""
Unified Version Synchronization for Chrome DevTools Optimizer

Single source of truth: version.json
Syncs version across: plugin.json, README.md
"""
...
def main():
    ...
    print("=" * 60)
    print("Chrome DevTools Optimizer - Version Synchronization")
    print("=" * 60)
