#!/usr/bin/env python3
"""
Unified Version Synchronization for Incident Response Playbook Creator

Single source of truth: version.json
Syncs version across: plugin.json, README.md, SKILL.md, agent file
"""
...
def update_markdown_file(filepath: Path, version: str, dry_run: bool = True) -> bool:
    ...
    # Pattern: **Version:** X.Y.Z or Version: X.Y.Z or **Version**: X.Y.Z
    patterns = [
...
def main():
    ...
    print("=" * 60)
    print("Incident Response Playbook Creator - Version Synchronization")
    print("=" * 60)
    ...
    files_to_sync = [
        ...
        ("agent file", lambda: update_markdown_file(base_dir / "agents" / "incident-response-playbook-creator.md", version, dry_run)),
    ]
