...
trigger: When user provides PDF file path, needs PDF extraction, encounters PDF too large errors, or wants to analyze technical documentation, compliance frameworks, or research papers
